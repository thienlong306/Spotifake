      ...
      <div className="sidebar__suggest-album">
        <div className="suggest-album">
          <div className="suggest-album__img-container">
            <img src={this.props.player.imageSongURL} alt="" />
          </div>
          <div className="suggest-album__content">
            <div className="suggest-album__info">
              <h4>{this.props.player.nameSong!=null?this.props.player.nameSong.split('.')[1]:"null"}</h4>
              <p>{this.props.player.nameSong!=null?this.props.player.nameSong.split('.')[0]:"null"}</p>
            </div>
