        ...
        <div className="play-song">
          <div className="play-control">
            ...
            <div className="play-control__volume">
              ...
              <input type="range" id="volume" className="volume" defaultValue={100} onChange={()=>{this.updateVolume()}} />
            </div>
          </div>
          <div className="play-seekbar">
            <div className="timer__left">0:00</div>
            <input type="range" name="range" id="range" className="range" defaultValue={0} onChange={()=>{this.updateRange()}}/>
            <audio
              autoPlay
